...
// TODO: make this not Khulnasoft-specific
var TAG_PATTERN = regexp.MustCompile(`(khulnasoft/.+):(.+)@(sha256:[[:alnum:]]+)`)
...
Examples:
	...
	$ update-docker-tags --update=khulnasoft/frontend
	...
	$ update-docker-tags --enforce=khulnasoft/frontend=~3.19
